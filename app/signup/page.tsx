    ...
    <div className="min-h-screen bg-cream flex items-center justify-center px-6">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="font-heading text-3xl font-semibold text-navy mb-2">Start your free trial</h1>
          <p className="text-t2 text-sm">14 days free · No credit card required</p>
        </div>
        <div className="bg-white border border-border rounded-2xl p-8 shadow-s2">
          <form className="flex flex-col gap-4">
            ...
            <div>
              ...
              <input type="password" placeholder="••••••••" className="w-full px-4 py-3 rounded-xl border border-border bg-cream text-sm focus:outline-none focus:border-teal focus:ring-1 focus:ring-teal" />
            </div>
          ...
          <p className="text-center text-sm text-t3 mt-5">
            ...
            <Link href="/login" className="text-teal font-semibold no-underline hover:underline">Sign in</Link>
          </p>
        </div>
      </div>
    </div>
