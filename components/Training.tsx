...
const cdaCourses = [
  { icon: "🧒", iconBg: "bg-mist", name: "Child Development Milestones", meta: "3.0 CEU hrs · CDA Unit 1 · Accredited", status: "complete" },
  { icon: "🚨", iconBg: "bg-[#fef3e2]", name: "Health, Safety & Nutrition", meta: "2.5 CEU hrs · CDA Unit 2 · Accredited", progress: 72 },
    ...
    <section className="py-24 bg-[#F0F7FC]" id="training">
      <div className="max-w-wrap mx-auto px-9">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          {/* Left text */}
          <div>
            <div className="inline-flex items-center gap-[7px] text-[11px] font-semibold tracking-[.12em] uppercase text-[#E8860A] px-3.5 py-[5px] bg-[#fef3e2] border border-[rgba(232,134,10,.25)] rounded-full mb-[18px]">
            ...
            {/* CDA Badge */}
            <div className="inline-flex items-center gap-2.5 bg-gradient-to-br from-[#fef3e2] to-[#fff9f0] border border-[rgba(232,134,10,.25)] rounded-xl p-3 px-4 mt-[22px] mb-1.5">
              <div className="text-[22px]">🏆</div>
              <div>
                <div className="text-sm font-bold text-ink">CDA Credential Pathway Available</div>
                <div className="text-xs text-slate/60 mt-px">State-approved, accredited modules that count toward the Child Development Associate — the gold standard in early childhood education</div>
              </div>
            </div>
              ...
              {[
                ...
                <FadeIn key={i} delay={i as 0 | 1 | 2 | 3 | 4}>
                  <div className="flex items-start gap-[11px]">
                    <div className="w-[21px] h-[21px] rounded-full bg-teal flex items-center justify-center text-[10px] text-ink font-bold shrink-0 mt-0.5">
                      <svg viewBox="0 0 12 12" fill="none" className="w-2.5 h-2.5">
                        <path d="M2.5 6l2.5 2.5 4.5-5" stroke="#0D1B2A" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                      </svg>
                    </div>
                    <div
                      className="text-sm text-slate leading-[1.55] [&_strong]:text-ink"
            ...
            <div className="border border-border rounded-[22px] overflow-hidden shadow-s3">
              ...
              <div className="bg-ink px-5 py-4 flex items-center justify-between">
                <div className="flex items-center gap-2.5">
                  ...
                  <span className="text-[9px] bg-teal text-ink px-2 py-0.5 rounded-full font-extrabold tracking-wider">
                    LIVE
                  </span>
                </div>
              ...
              <div className="px-[18px] py-3.5 border-b border-border">
                <div className="text-[9px] font-bold uppercase tracking-[.1em] text-slate/60 mb-2.5">🏆 CDA Pathway — Ms. Johnson</div>
                {cdaCourses.map((course) => (
                  <div key={course.name} className="flex items-center gap-2.5 py-[9px] border-b border-[#f5f3f0] last:border-b-0">
                    ...
                    <div>
                      <div className="text-xs font-semibold text-ink">{course.name}</div>
                      <div className="text-[10px] text-slate/60 mt-px">{course.meta}</div>
                    </div>
                    <div className="ml-auto text-right">
                      {course.status === "complete" ? (
                        ...
                        <>
                          ...
                          <div className="text-[9px] text-slate/60 font-semibold">
              ...
              <div className="px-[18px] py-3.5">
                <div className="text-[9px] font-bold uppercase tracking-[.1em] text-slate/60 mb-2.5">Staff Compliance — March 2026</div>
                {compliance.map((row) => (
                  <div key={row.name} className="flex items-center justify-between py-[7px] border-b border-[#f5f3f0] last:border-b-0">
                    <div>
                      <div className="text-[11px] font-medium text-ink">{row.name}</div>
                      <div className="text-[10px] text-slate/60 mt-px">{row.hours}</div>
                    </div>
              ...
              <div className="px-[18px] py-[13px] bg-gradient-to-r from-[rgba(232,134,10,.06)] to-[rgba(232,134,10,.1)] border-t border-[rgba(232,134,10,.15)] flex items-center gap-[9px]">
                ...
                <div className="text-xs text-[#E8860A] font-medium flex-1">
                  <strong>Team compliance this quarter</strong><br />9 of 12 staff fully current · 3 need hours
                </div>
                <div className="font-heading text-[22px] font-semibold text-[#E8860A]">75%</div>
              </div>
            </div>
          </FadeIn>
        </div>
